...
# (flutter_local_notifications 22.x, google_sign_in, geolocator, firebase_*
# etc. all ship their own consumer-rules.pro inside their AARs, which R8
# picks up automatically — no manual keep rules were found to be required
# for any of them as of the versions pinned in pubspec.yaml/pubspec.lock).

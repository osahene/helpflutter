...
class MockTutorialRepository implements TutorialRepository {
  final List<Tutorial> _mockTutorials = [
    Tutorial(
      ...
      category: 'fire',
      thumbnailUrl: 'assets/thumbnails/fire.png',
    ...
    Tutorial(
      ...
      category: 'health',
      thumbnailUrl: 'assets/thumbnails/burns.png',
    ...
    Tutorial(
      ...
      category: 'flood',
      thumbnailUrl: 'assets/thumbnails/flood_safe.png',
    ...
    Tutorial(
      ...
      category: 'robbery',
      thumbnailUrl: 'assets/thumbnails/robbery.png',
    ...
    Tutorial(
      ...
      category: 'accident',
      thumbnailUrl: 'assets/thumbnails/accident.png',
